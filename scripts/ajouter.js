  ...
  var handleSubmit=  function handleSubmit(event) {
        ...
        if (!validateDate(date) || !validateNom(nom) || !validateNumeroTelephone(numeroTelephone) || !validateVille(ville) || !validateSurface(surface)) {
            return; 
        }
...
function validateNumeroTelephone(numeroTelephone) {
    if (!numeroTelephone) {
        displayErrorMessage('NumeroTelephone', 'Veuillez entrer un numéro de téléphone.');
        return false;
    }
